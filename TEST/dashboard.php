        ...
        <ul class="side-menu">
            ...
            <li>
                <a href="#"><i class='bx bxs-inbox icon'></i>Elements<i
                        class='bx bx-chevron-right icon-right'></i></box-icon></a>
            ...
            <ul>
                ...
                <li> <a href="?action=runFunction"><i class='bx bxs-log-out icon'></i>Logout</a></li>
            </ul>
        </ul>
    </section>
            ...
            <div class="profile">
                <a href="#"><img src="img/user.png" alt="User">
                    ...
                    <ul class="profile-link">
                        <li><a href="update_profile.php"><i class='bx bxs-user-circle icon' type='solid'></i>Profile</a></li>
                        <li><a href="?action=runFunction"><i class='bx bxs-user-circle icon' type='solid'></i>Logout</a></li>
                    </ul>
